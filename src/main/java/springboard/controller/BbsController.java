...
/*
 기본 패키지로 설정한 곳에 컨트롤러를 선언하면 요청이 들어왔을때
 Auto scan된다. 해당 설정은 servlet-context.xml서 추가한다.
 */
@Controller
public class BbsController {
	...
	public void setTemplate(JdbcTemplate template) {
		...
		//Jdbc Template을 해당 프로그램 전체에서 사용하기 위한 설정.(static 설정)
	...
	public String list(Model model, HttpServletRequest req) {
		...
		/*
		 ...
		 ListCommand객체로 전달하기 위해 Model객체에 저장 한 후 매개변수로
		 전달한다.
		 */
	...
	public String password(Model model, HttpServletRequest req) {
		//일련번호는 컨트롤러에서 파라미터를 받은 후 Model에 저장한다.
